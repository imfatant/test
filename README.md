...
1) The R/C receiver: FrSky equipment, like the R-XSR, XR4SB or R9 Slim can be powered off any 5V pin and a GND. All that remains is to connect the receiver's SBUS OUT ... (in the process of writing) ...
