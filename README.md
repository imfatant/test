...
- The R/C receiver: FrSky equipment, like the R-XSR, XR4SB, X6R, X8R or R9 Slim can be powered off any +5V pin and a GND. The +5V servo rail, providing it's powered, will do too. All that remains is to connect the receiver's SBUS OUT to one of the two SBUS pins marked on the diagram. A signal inverter is not necessary. Please contact me if you would like to add some information here about gear from other manufacturers such as Spektrum, Futaba, etc.
- The GPS receiver: Most people seem to recommend the u-blox receivers, particularly the NEO-M8N and NEO-M8P. The former is easily obtained online from Chinese companies like HobbyKing, and in a variety of disc-shaped packages. Conveniently, these packages contain the receiver itself, a very small ceramic patch antenna, and often include a solid-state compass.
...
...
...
...
