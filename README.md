...
- The R/C receiver: FrSky equipment, like the R-XSR, XR4SB or R9 Slim can be powered off any +5V pin and a GND. The +5V servo rail, providing it's powered, will do too. All that remains is to connect the receiver's SBUS OUT to one of the two SBUS pins marked in the diagram.
