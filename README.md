...
4) Hopefully, you now find yourself logged into the debian user account and at the command prompt. The next task is to update and install some software using an internet connection. Usually you'll share your computer's internet connection with the BBBlue.
