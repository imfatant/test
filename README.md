...
- The GPS receiver: Most people seem to recommend the u-blox receivers, particularly the NEO-M8N and NEO-M8P. The former is easily obtained online from Chinese companies like HobbyKing (https://hobbyking.com/en_us/catalogsearch/result/?cat=&q=ublox), and in a variety of disc-shaped packages. Conveniently, these packages contain the receiver itself, a very small ceramic patch antenna, and often include a solid-state compass... under construction ...
