...
# Part 1.
0) Before I begin, I want to stress that supplying the BeageBone Blue with adequate power is a must. Typically, we'll be attaching quite a few peripherals to it, and they'll not behave correctly without enough juice.
