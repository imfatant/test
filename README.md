...
Here's a quickstart chart for the BBBlue's pinouts (save the file and open it in an appropriate image viewer for better resolution): https://github.com/imfatant/test/blob/master/bbblue_pinouts.jpg
