...
13) When the BBBlue comes back up, we need to create a few text files. Use your favourite text editor. Personally, I like nano, which, owing to the way these Debian images have been built, is invoked automatically if you use the `sudoedit` command. First, the ArduPilot environment configuration file, /etc/default/ardupilot:
